...
export function UncategorizedTransactions() {
  ...
  // Get only uncategorized transactions (no categoryId)
  ...
  const transactions = useQuery(api.transactions.getUncategorizedTransactions, {
    paginationOpts,
    ...convexSorting,
  });

  const handleCategoryChange = useCallback((transactionId: Id<"transactions">, categoryId?: Id<"categories">) => {
    if (!categoryId) return; // Don't allow removing category in this view
        ...
        cell: (info) => (
          <div className="flex items-center space-x-2">
            <CategoryDropdown
              ...
              selectedCategoryId={undefined} // Always show as uncategorized
    ...
    return (
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h2 className="text-2xl font-semibold text-gray-900">Uncategorized Transactions</h2>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {transactions.page.length} transactions need to be categorized
          </p>
        </div>
      </div>
